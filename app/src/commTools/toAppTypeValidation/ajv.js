"use strict";
export const Open = validate10;
var schema11 = {"$id":"Open","additionalProperties":false,"type":"object","properties":{"id":{"type":"string"},"title":{"type":"string"},"initialState":{},"queryId":{"type":"string"},"layout":{"enum":["merge-bottom","merge-left","merge-right","merge-top","split-bottom","split-left","split-right","tab-after","tab-before"],"type":"string"}},"required":["id","queryId"],"definitions":{"AddValidatorName<{id:string;title?:string|undefined;initialState?:unknown;queryId:string;layout?:\"merge-bottom\"|\"merge-left\"|\"merge-right\"|\"merge-top\"|\"split-bottom\"|\"split-left\"|\"split-right\"|\"tab-after\"|\"tab-before\"|undefined;},\"Open\">":{"additionalProperties":false,"type":"object","properties":{"id":{"type":"string"},"title":{"type":"string"},"initialState":{},"queryId":{"type":"string"},"layout":{"enum":["merge-bottom","merge-left","merge-right","merge-top","split-bottom","split-left","split-right","tab-after","tab-before"],"type":"string"}},"required":["id","queryId"]},"AddValidatorName<{type:\"Close\";},\"Close\">":{"additionalProperties":false,"type":"object","properties":{"type":{"type":"string","const":"Close"}},"required":["type"]},"AddValidatorName<{action:{type:string;payload:any;};}&{type:\"Dispatch\";},\"Dispatch\">":{"additionalProperties":false,"type":"object","properties":{"action":{"type":"object","properties":{"type":{"type":"string"},"payload":{}},"additionalProperties":false,"required":["payload","type"]},"type":{"type":"string","const":"Dispatch"}},"required":["action","type"]},"AddValidatorName<{params:{title:string;body:string;};}&{type:\"ShowError\";},\"ShowError\">":{"additionalProperties":false,"type":"object","properties":{"params":{"type":"object","properties":{"title":{"type":"string"},"body":{"type":"string"}},"additionalProperties":false,"required":["body","title"]},"type":{"type":"string","const":"ShowError"}},"required":["params","type"]},"AddValidatorName<{level:\"log\"|\"info\"|\"debug\"|\"warn\";args:any[];}&{type:\"FrontendConsole\";},\"FrontendConsole\">":{"additionalProperties":false,"type":"object","properties":{"level":{"enum":["debug","info","log","warn"],"type":"string"},"args":{"type":"array","items":{}},"type":{"type":"string","const":"FrontendConsole"}},"required":["args","level","type"]},"AddValidatorName<{title:string;}&{type:\"UpdateWidgetState\";},\"UpdateWidgetState\">":{"additionalProperties":false,"type":"object","properties":{"title":{"type":"string"},"type":{"type":"string","const":"UpdateWidgetState"}},"required":["title","type"]},"AddValidatorName<{window_ids:string[];}&{type:\"LockFrame\";},\"LockFrame\">":{"additionalProperties":false,"type":"object","properties":{"window_ids":{"type":"array","items":{"type":"string"}},"type":{"type":"string","const":"LockFrame"}},"required":["type","window_ids"]},"AddValidatorName<{window_ids:string[];}&{type:\"UnlockFrame\";},\"UnlockFrame\">":{"additionalProperties":false,"type":"object","properties":{"window_ids":{"type":"array","items":{"type":"string"}},"type":{"type":"string","const":"UnlockFrame"}},"required":["type","window_ids"]},"AddValidatorName<{queryId:string;baseRevision:number;}&{type:\"QueryState\";},\"QueryState\">":{"additionalProperties":false,"type":"object","properties":{"queryId":{"type":"string"},"baseRevision":{"type":"integer"},"type":{"type":"string","const":"QueryState"}},"required":["baseRevision","queryId","type"]},"AddValidatorName<{queryId:string;aspectRatio?:number|undefined;}&{type:\"QuerySnapshot\";},\"QuerySnapshot\">":{"additionalProperties":false,"type":"object","properties":{"queryId":{"type":"string"},"aspectRatio":{"type":"number"},"type":{"type":"string","const":"QuerySnapshot"}},"required":["queryId","type"]},"AddValidatorName<{ra:number;dec:number;fov?:number|undefined;duration:number;easingFunction?:\"linear\"|\"fastStart2\"|\"fastStart4\"|\"slowStart2\"|\"slowStart4\"|\"slowStartStop2\"|\"slowStartStop4\"|undefined;}&{type:\"JumpTo\";},\"JumpTo\">":{"additionalProperties":false,"type":"object","properties":{"ra":{"type":"number"},"dec":{"type":"number"},"fov":{"type":"number"},"duration":{"type":"number"},"easingFunction":{"enum":["fastStart2","fastStart4","linear","slowStart2","slowStart4","slowStartStop2","slowStartStop4"],"type":"string"},"type":{"type":"string","const":"JumpTo"}},"required":["dec","duration","ra","type"]}}};

function validate10(data, valCxt){
"use strict"; /*# sourceURL="Open" */;
if(valCxt){
...
if(!(((((key0 === "id") || (key0 === "title")) || (key0 === "initialState")) || (key0 === "queryId")) || (key0 === "layout"))){
...
validate10.errors = [{instancePath:instancePath+"/queryId",schemaPath:"#/properties/queryId/type",keyword:"type",params:{type: "string"},message:"must be string"}];
return false;
}
...
var data3 = data.layout;
var _errs8 = errors;
if(typeof data3 !== "string"){
validate10.errors = [{instancePath:instancePath+"/layout",schemaPath:"#/properties/layout/type",keyword:"type",params:{type: "string"},message:"must be string"}];
return false;
}
if(!(((((((((data3 === "merge-bottom") || (data3 === "merge-left")) || (data3 === "merge-right")) || (data3 === "merge-top")) || (data3 === "split-bottom")) || (data3 === "split-left")) || (data3 === "split-right")) || (data3 === "tab-after")) || (data3 === "tab-before"))){
validate10.errors = [{instancePath:instancePath+"/layout",schemaPath:"#/properties/layout/enum",keyword:"enum",params:{allowedValues: schema11.properties.layout.enum},message:"must be equal to one of the allowed values"}];
return false;
}
...
export const Close = validate11;
var schema12 = {"$id":"Close","additionalProperties":false,"type":"object","properties":{"type":{"type":"string","const":"Close"}},"required":["type"],"definitions":{"AddValidatorName<{id:string;title?:string|undefined;initialState?:unknown;queryId:string;layout?:\"merge-bottom\"|\"merge-left\"|\"merge-right\"|\"merge-top\"|\"split-bottom\"|\"split-left\"|\"split-right\"|\"tab-after\"|\"tab-before\"|undefined;},\"Open\">":{"additionalProperties":false,"type":"object","properties":{"id":{"type":"string"},"title":{"type":"string"},"initialState":{},"queryId":{"type":"string"},"layout":{"enum":["merge-bottom","merge-left","merge-right","merge-top","split-bottom","split-left","split-right","tab-after","tab-before"],"type":"string"}},"required":["id","queryId"]},"AddValidatorName<{type:\"Close\";},\"Close\">":{"additionalProperties":false,"type":"object","properties":{"type":{"type":"string","const":"Close"}},"required":["type"]},"AddValidatorName<{action:{type:string;payload:any;};}&{type:\"Dispatch\";},\"Dispatch\">":{"additionalProperties":false,"type":"object","properties":{"action":{"type":"object","properties":{"type":{"type":"string"},"payload":{}},"additionalProperties":false,"required":["payload","type"]},"type":{"type":"string","const":"Dispatch"}},"required":["action","type"]},"AddValidatorName<{params:{title:string;body:string;};}&{type:\"ShowError\";},\"ShowError\">":{"additionalProperties":false,"type":"object","properties":{"params":{"type":"object","properties":{"title":{"type":"string"},"body":{"type":"string"}},"additionalProperties":false,"required":["body","title"]},"type":{"type":"string","const":"ShowError"}},"required":["params","type"]},"AddValidatorName<{level:\"log\"|\"info\"|\"debug\"|\"warn\";args:any[];}&{type:\"FrontendConsole\";},\"FrontendConsole\">":{"additionalProperties":false,"type":"object","properties":{"level":{"enum":["debug","info","log","warn"],"type":"string"},"args":{"type":"array","items":{}},"type":{"type":"string","const":"FrontendConsole"}},"required":["args","level","type"]},"AddValidatorName<{title:string;}&{type:\"UpdateWidgetState\";},\"UpdateWidgetState\">":{"additionalProperties":false,"type":"object","properties":{"title":{"type":"string"},"type":{"type":"string","const":"UpdateWidgetState"}},"required":["title","type"]},"AddValidatorName<{window_ids:string[];}&{type:\"LockFrame\";},\"LockFrame\">":{"additionalProperties":false,"type":"object","properties":{"window_ids":{"type":"array","items":{"type":"string"}},"type":{"type":"string","const":"LockFrame"}},"required":["type","window_ids"]},"AddValidatorName<{window_ids:string[];}&{type:\"UnlockFrame\";},\"UnlockFrame\">":{"additionalProperties":false,"type":"object","properties":{"window_ids":{"type":"array","items":{"type":"string"}},"type":{"type":"string","const":"UnlockFrame"}},"required":["type","window_ids"]},"AddValidatorName<{queryId:string;baseRevision:number;}&{type:\"QueryState\";},\"QueryState\">":{"additionalProperties":false,"type":"object","properties":{"queryId":{"type":"string"},"baseRevision":{"type":"integer"},"type":{"type":"string","const":"QueryState"}},"required":["baseRevision","queryId","type"]},"AddValidatorName<{queryId:string;aspectRatio?:number|undefined;}&{type:\"QuerySnapshot\";},\"QuerySnapshot\">":{"additionalProperties":false,"type":"object","properties":{"queryId":{"type":"string"},"aspectRatio":{"type":"number"},"type":{"type":"string","const":"QuerySnapshot"}},"required":["queryId","type"]},"AddValidatorName<{ra:number;dec:number;fov?:number|undefined;duration:number;easingFunction?:\"linear\"|\"fastStart2\"|\"fastStart4\"|\"slowStart2\"|\"slowStart4\"|\"slowStartStop2\"|\"slowStartStop4\"|undefined;}&{type:\"JumpTo\";},\"JumpTo\">":{"additionalProperties":false,"type":"object","properties":{"ra":{"type":"number"},"dec":{"type":"number"},"fov":{"type":"number"},"duration":{"type":"number"},"easingFunction":{"enum":["fastStart2","fastStart4","linear","slowStart2","slowStart4","slowStartStop2","slowStartStop4"],"type":"string"},"type":{"type":"string","const":"JumpTo"}},"required":["dec","duration","ra","type"]}}};
...
if("Close" !== data0){
validate11.errors = [{instancePath:instancePath+"/type",schemaPath:"#/properties/type/const",keyword:"const",params:{allowedValue: "Close"},message:"must be equal to constant"}];
return false;
}
}
}
...
export const Dispatch = validate12;
var schema13 = {"$id":"Dispatch","additionalProperties":false,"type":"object","properties":{"action":{"type":"object","properties":{"type":{"type":"string"},"payload":{}},"additionalProperties":false,"required":["payload","type"]},"type":{"type":"string","const":"Dispatch"}},"required":["action","type"],"definitions":{"AddValidatorName<{id:string;title?:string|undefined;initialState?:unknown;queryId:string;layout?:\"merge-bottom\"|\"merge-left\"|\"merge-right\"|\"merge-top\"|\"split-bottom\"|\"split-left\"|\"split-right\"|\"tab-after\"|\"tab-before\"|undefined;},\"Open\">":{"additionalProperties":false,"type":"object","properties":{"id":{"type":"string"},"title":{"type":"string"},"initialState":{},"queryId":{"type":"string"},"layout":{"enum":["merge-bottom","merge-left","merge-right","merge-top","split-bottom","split-left","split-right","tab-after","tab-before"],"type":"string"}},"required":["id","queryId"]},"AddValidatorName<{type:\"Close\";},\"Close\">":{"additionalProperties":false,"type":"object","properties":{"type":{"type":"string","const":"Close"}},"required":["type"]},"AddValidatorName<{action:{type:string;payload:any;};}&{type:\"Dispatch\";},\"Dispatch\">":{"additionalProperties":false,"type":"object","properties":{"action":{"type":"object","properties":{"type":{"type":"string"},"payload":{}},"additionalProperties":false,"required":["payload","type"]},"type":{"type":"string","const":"Dispatch"}},"required":["action","type"]},"AddValidatorName<{params:{title:string;body:string;};}&{type:\"ShowError\";},\"ShowError\">":{"additionalProperties":false,"type":"object","properties":{"params":{"type":"object","properties":{"title":{"type":"string"},"body":{"type":"string"}},"additionalProperties":false,"required":["body","title"]},"type":{"type":"string","const":"ShowError"}},"required":["params","type"]},"AddValidatorName<{level:\"log\"|\"info\"|\"debug\"|\"warn\";args:any[];}&{type:\"FrontendConsole\";},\"FrontendConsole\">":{"additionalProperties":false,"type":"object","properties":{"level":{"enum":["debug","info","log","warn"],"type":"string"},"args":{"type":"array","items":{}},"type":{"type":"string","const":"FrontendConsole"}},"required":["args","level","type"]},"AddValidatorName<{title:string;}&{type:\"UpdateWidgetState\";},\"UpdateWidgetState\">":{"additionalProperties":false,"type":"object","properties":{"title":{"type":"string"},"type":{"type":"string","const":"UpdateWidgetState"}},"required":["title","type"]},"AddValidatorName<{window_ids:string[];}&{type:\"LockFrame\";},\"LockFrame\">":{"additionalProperties":false,"type":"object","properties":{"window_ids":{"type":"array","items":{"type":"string"}},"type":{"type":"string","const":"LockFrame"}},"required":["type","window_ids"]},"AddValidatorName<{window_ids:string[];}&{type:\"UnlockFrame\";},\"UnlockFrame\">":{"additionalProperties":false,"type":"object","properties":{"window_ids":{"type":"array","items":{"type":"string"}},"type":{"type":"string","const":"UnlockFrame"}},"required":["type","window_ids"]},"AddValidatorName<{queryId:string;baseRevision:number;}&{type:\"QueryState\";},\"QueryState\">":{"additionalProperties":false,"type":"object","properties":{"queryId":{"type":"string"},"baseRevision":{"type":"integer"},"type":{"type":"string","const":"QueryState"}},"required":["baseRevision","queryId","type"]},"AddValidatorName<{queryId:string;aspectRatio?:number|undefined;}&{type:\"QuerySnapshot\";},\"QuerySnapshot\">":{"additionalProperties":false,"type":"object","properties":{"queryId":{"type":"string"},"aspectRatio":{"type":"number"},"type":{"type":"string","const":"QuerySnapshot"}},"required":["queryId","type"]},"AddValidatorName<{ra:number;dec:number;fov?:number|undefined;duration:number;easingFunction?:\"linear\"|\"fastStart2\"|\"fastStart4\"|\"slowStart2\"|\"slowStart4\"|\"slowStartStop2\"|\"slowStartStop4\"|undefined;}&{type:\"JumpTo\";},\"JumpTo\">":{"additionalProperties":false,"type":"object","properties":{"ra":{"type":"number"},"dec":{"type":"number"},"fov":{"type":"number"},"duration":{"type":"number"},"easingFunction":{"enum":["fastStart2","fastStart4","linear","slowStart2","slowStart4","slowStartStop2","slowStartStop4"],"type":"string"},"type":{"type":"string","const":"JumpTo"}},"required":["dec","duration","ra","type"]}}};
...
validate12.errors = [{instancePath:instancePath+"/action",schemaPath:"#/properties/action/required",keyword:"required",params:{missingProperty: missing1},message:"must have required property '"+missing1+"'"}];
return false;
}
else {
var _errs4 = errors;
...
validate12.errors = [{instancePath:instancePath+"/action",schemaPath:"#/properties/action/additionalProperties",keyword:"additionalProperties",params:{additionalProperty: key1},message:"must NOT have additional properties"}];
return false;
break;
}
}
...
validate12.errors = [{instancePath:instancePath+"/action/type",schemaPath:"#/properties/action/properties/type/type",keyword:"type",params:{type: "string"},message:"must be string"}];
return false;
}
}
}
...
validate12.errors = [{instancePath:instancePath+"/action",schemaPath:"#/properties/action/type",keyword:"type",params:{type: "object"},message:"must be object"}];
return false;
}
}
var valid0 = _errs2 === errors;
...
if("Dispatch" !== data2){
validate12.errors = [{instancePath:instancePath+"/type",schemaPath:"#/properties/type/const",keyword:"const",params:{allowedValue: "Dispatch"},message:"must be equal to constant"}];
return false;
}
...
export const ShowError = validate13;
var schema14 = {"$id":"ShowError","additionalProperties":false,"type":"object","properties":{"params":{"type":"object","properties":{"title":{"type":"string"},"body":{"type":"string"}},"additionalProperties":false,"required":["body","title"]},"type":{"type":"string","const":"ShowError"}},"required":["params","type"],"definitions":{"AddValidatorName<{id:string;title?:string|undefined;initialState?:unknown;queryId:string;layout?:\"merge-bottom\"|\"merge-left\"|\"merge-right\"|\"merge-top\"|\"split-bottom\"|\"split-left\"|\"split-right\"|\"tab-after\"|\"tab-before\"|undefined;},\"Open\">":{"additionalProperties":false,"type":"object","properties":{"id":{"type":"string"},"title":{"type":"string"},"initialState":{},"queryId":{"type":"string"},"layout":{"enum":["merge-bottom","merge-left","merge-right","merge-top","split-bottom","split-left","split-right","tab-after","tab-before"],"type":"string"}},"required":["id","queryId"]},"AddValidatorName<{type:\"Close\";},\"Close\">":{"additionalProperties":false,"type":"object","properties":{"type":{"type":"string","const":"Close"}},"required":["type"]},"AddValidatorName<{action:{type:string;payload:any;};}&{type:\"Dispatch\";},\"Dispatch\">":{"additionalProperties":false,"type":"object","properties":{"action":{"type":"object","properties":{"type":{"type":"string"},"payload":{}},"additionalProperties":false,"required":["payload","type"]},"type":{"type":"string","const":"Dispatch"}},"required":["action","type"]},"AddValidatorName<{params:{title:string;body:string;};}&{type:\"ShowError\";},\"ShowError\">":{"additionalProperties":false,"type":"object","properties":{"params":{"type":"object","properties":{"title":{"type":"string"},"body":{"type":"string"}},"additionalProperties":false,"required":["body","title"]},"type":{"type":"string","const":"ShowError"}},"required":["params","type"]},"AddValidatorName<{level:\"log\"|\"info\"|\"debug\"|\"warn\";args:any[];}&{type:\"FrontendConsole\";},\"FrontendConsole\">":{"additionalProperties":false,"type":"object","properties":{"level":{"enum":["debug","info","log","warn"],"type":"string"},"args":{"type":"array","items":{}},"type":{"type":"string","const":"FrontendConsole"}},"required":["args","level","type"]},"AddValidatorName<{title:string;}&{type:\"UpdateWidgetState\";},\"UpdateWidgetState\">":{"additionalProperties":false,"type":"object","properties":{"title":{"type":"string"},"type":{"type":"string","const":"UpdateWidgetState"}},"required":["title","type"]},"AddValidatorName<{window_ids:string[];}&{type:\"LockFrame\";},\"LockFrame\">":{"additionalProperties":false,"type":"object","properties":{"window_ids":{"type":"array","items":{"type":"string"}},"type":{"type":"string","const":"LockFrame"}},"required":["type","window_ids"]},"AddValidatorName<{window_ids:string[];}&{type:\"UnlockFrame\";},\"UnlockFrame\">":{"additionalProperties":false,"type":"object","properties":{"window_ids":{"type":"array","items":{"type":"string"}},"type":{"type":"string","const":"UnlockFrame"}},"required":["type","window_ids"]},"AddValidatorName<{queryId:string;baseRevision:number;}&{type:\"QueryState\";},\"QueryState\">":{"additionalProperties":false,"type":"object","properties":{"queryId":{"type":"string"},"baseRevision":{"type":"integer"},"type":{"type":"string","const":"QueryState"}},"required":["baseRevision","queryId","type"]},"AddValidatorName<{queryId:string;aspectRatio?:number|undefined;}&{type:\"QuerySnapshot\";},\"QuerySnapshot\">":{"additionalProperties":false,"type":"object","properties":{"queryId":{"type":"string"},"aspectRatio":{"type":"number"},"type":{"type":"string","const":"QuerySnapshot"}},"required":["queryId","type"]},"AddValidatorName<{ra:number;dec:number;fov?:number|undefined;duration:number;easingFunction?:\"linear\"|\"fastStart2\"|\"fastStart4\"|\"slowStart2\"|\"slowStart4\"|\"slowStartStop2\"|\"slowStartStop4\"|undefined;}&{type:\"JumpTo\";},\"JumpTo\">":{"additionalProperties":false,"type":"object","properties":{"ra":{"type":"number"},"dec":{"type":"number"},"fov":{"type":"number"},"duration":{"type":"number"},"easingFunction":{"enum":["fastStart2","fastStart4","linear","slowStart2","slowStart4","slowStartStop2","slowStartStop4"],"type":"string"},"type":{"type":"string","const":"JumpTo"}},"required":["dec","duration","ra","type"]}}};
...
validate13.errors = [{instancePath:instancePath+"/params",schemaPath:"#/properties/params/required",keyword:"required",params:{missingProperty: missing1},message:"must have required property '"+missing1+"'"}];
return false;
}
else {
var _errs4 = errors;
...
validate13.errors = [{instancePath:instancePath+"/params",schemaPath:"#/properties/params/additionalProperties",keyword:"additionalProperties",params:{additionalProperty: key1},message:"must NOT have additional properties"}];
return false;
break;
}
}
...
validate13.errors = [{instancePath:instancePath+"/params/title",schemaPath:"#/properties/params/properties/title/type",keyword:"type",params:{type: "string"},message:"must be string"}];
return false;
}
...
validate13.errors = [{instancePath:instancePath+"/params/body",schemaPath:"#/properties/params/properties/body/type",keyword:"type",params:{type: "string"},message:"must be string"}];
return false;
}
...
validate13.errors = [{instancePath:instancePath+"/params",schemaPath:"#/properties/params/type",keyword:"type",params:{type: "object"},message:"must be object"}];
return false;
}
}
var valid0 = _errs2 === errors;
...
if("ShowError" !== data3){
validate13.errors = [{instancePath:instancePath+"/type",schemaPath:"#/properties/type/const",keyword:"const",params:{allowedValue: "ShowError"},message:"must be equal to constant"}];
return false;
}
...
export const FrontendConsole = validate14;
var schema15 = {"$id":"FrontendConsole","additionalProperties":false,"type":"object","properties":{"level":{"enum":["debug","info","log","warn"],"type":"string"},"args":{"type":"array","items":{}},"type":{"type":"string","const":"FrontendConsole"}},"required":["args","level","type"],"definitions":{"AddValidatorName<{id:string;title?:string|undefined;initialState?:unknown;queryId:string;layout?:\"merge-bottom\"|\"merge-left\"|\"merge-right\"|\"merge-top\"|\"split-bottom\"|\"split-left\"|\"split-right\"|\"tab-after\"|\"tab-before\"|undefined;},\"Open\">":{"additionalProperties":false,"type":"object","properties":{"id":{"type":"string"},"title":{"type":"string"},"initialState":{},"queryId":{"type":"string"},"layout":{"enum":["merge-bottom","merge-left","merge-right","merge-top","split-bottom","split-left","split-right","tab-after","tab-before"],"type":"string"}},"required":["id","queryId"]},"AddValidatorName<{type:\"Close\";},\"Close\">":{"additionalProperties":false,"type":"object","properties":{"type":{"type":"string","const":"Close"}},"required":["type"]},"AddValidatorName<{action:{type:string;payload:any;};}&{type:\"Dispatch\";},\"Dispatch\">":{"additionalProperties":false,"type":"object","properties":{"action":{"type":"object","properties":{"type":{"type":"string"},"payload":{}},"additionalProperties":false,"required":["payload","type"]},"type":{"type":"string","const":"Dispatch"}},"required":["action","type"]},"AddValidatorName<{params:{title:string;body:string;};}&{type:\"ShowError\";},\"ShowError\">":{"additionalProperties":false,"type":"object","properties":{"params":{"type":"object","properties":{"title":{"type":"string"},"body":{"type":"string"}},"additionalProperties":false,"required":["body","title"]},"type":{"type":"string","const":"ShowError"}},"required":["params","type"]},"AddValidatorName<{level:\"log\"|\"info\"|\"debug\"|\"warn\";args:any[];}&{type:\"FrontendConsole\";},\"FrontendConsole\">":{"additionalProperties":false,"type":"object","properties":{"level":{"enum":["debug","info","log","warn"],"type":"string"},"args":{"type":"array","items":{}},"type":{"type":"string","const":"FrontendConsole"}},"required":["args","level","type"]},"AddValidatorName<{title:string;}&{type:\"UpdateWidgetState\";},\"UpdateWidgetState\">":{"additionalProperties":false,"type":"object","properties":{"title":{"type":"string"},"type":{"type":"string","const":"UpdateWidgetState"}},"required":["title","type"]},"AddValidatorName<{window_ids:string[];}&{type:\"LockFrame\";},\"LockFrame\">":{"additionalProperties":false,"type":"object","properties":{"window_ids":{"type":"array","items":{"type":"string"}},"type":{"type":"string","const":"LockFrame"}},"required":["type","window_ids"]},"AddValidatorName<{window_ids:string[];}&{type:\"UnlockFrame\";},\"UnlockFrame\">":{"additionalProperties":false,"type":"object","properties":{"window_ids":{"type":"array","items":{"type":"string"}},"type":{"type":"string","const":"UnlockFrame"}},"required":["type","window_ids"]},"AddValidatorName<{queryId:string;baseRevision:number;}&{type:\"QueryState\";},\"QueryState\">":{"additionalProperties":false,"type":"object","properties":{"queryId":{"type":"string"},"baseRevision":{"type":"integer"},"type":{"type":"string","const":"QueryState"}},"required":["baseRevision","queryId","type"]},"AddValidatorName<{queryId:string;aspectRatio?:number|undefined;}&{type:\"QuerySnapshot\";},\"QuerySnapshot\">":{"additionalProperties":false,"type":"object","properties":{"queryId":{"type":"string"},"aspectRatio":{"type":"number"},"type":{"type":"string","const":"QuerySnapshot"}},"required":["queryId","type"]},"AddValidatorName<{ra:number;dec:number;fov?:number|undefined;duration:number;easingFunction?:\"linear\"|\"fastStart2\"|\"fastStart4\"|\"slowStart2\"|\"slowStart4\"|\"slowStartStop2\"|\"slowStartStop4\"|undefined;}&{type:\"JumpTo\";},\"JumpTo\">":{"additionalProperties":false,"type":"object","properties":{"ra":{"type":"number"},"dec":{"type":"number"},"fov":{"type":"number"},"duration":{"type":"number"},"easingFunction":{"enum":["fastStart2","fastStart4","linear","slowStart2","slowStart4","slowStartStop2","slowStartStop4"],"type":"string"},"type":{"type":"string","const":"JumpTo"}},"required":["dec","duration","ra","type"]}}};
...
var _errs2 = errors;
if(typeof data0 !== "string"){
validate14.errors = [{instancePath:instancePath+"/level",schemaPath:"#/properties/level/type",keyword:"type",params:{type: "string"},message:"must be string"}];
return false;
}
if(!((((data0 === "debug") || (data0 === "info")) || (data0 === "log")) || (data0 === "warn"))){
validate14.errors = [{instancePath:instancePath+"/level",schemaPath:"#/properties/level/enum",keyword:"enum",params:{allowedValues: schema15.properties.level.enum},message:"must be equal to one of the allowed values"}];
return false;
}
var valid0 = _errs2 === errors;
}
...
validate14.errors = [{instancePath:instancePath+"/args",schemaPath:"#/properties/args/type",keyword:"type",params:{type: "array"},message:"must be array"}];
return false;
}
}
var valid0 = _errs4 === errors;
...
validate14.errors = [{instancePath:instancePath+"/type",schemaPath:"#/properties/type/const",keyword:"const",params:{allowedValue: "FrontendConsole"},message:"must be equal to constant"}];
return false;
}
var valid0 = _errs6 === errors;
}
...
export const UpdateWidgetState = validate15;
var schema16 = {"$id":"UpdateWidgetState","additionalProperties":false,"type":"object","properties":{"title":{"type":"string"},"type":{"type":"string","const":"UpdateWidgetState"}},"required":["title","type"],"definitions":{"AddValidatorName<{id:string;title?:string|undefined;initialState?:unknown;queryId:string;layout?:\"merge-bottom\"|\"merge-left\"|\"merge-right\"|\"merge-top\"|\"split-bottom\"|\"split-left\"|\"split-right\"|\"tab-after\"|\"tab-before\"|undefined;},\"Open\">":{"additionalProperties":false,"type":"object","properties":{"id":{"type":"string"},"title":{"type":"string"},"initialState":{},"queryId":{"type":"string"},"layout":{"enum":["merge-bottom","merge-left","merge-right","merge-top","split-bottom","split-left","split-right","tab-after","tab-before"],"type":"string"}},"required":["id","queryId"]},"AddValidatorName<{type:\"Close\";},\"Close\">":{"additionalProperties":false,"type":"object","properties":{"type":{"type":"string","const":"Close"}},"required":["type"]},"AddValidatorName<{action:{type:string;payload:any;};}&{type:\"Dispatch\";},\"Dispatch\">":{"additionalProperties":false,"type":"object","properties":{"action":{"type":"object","properties":{"type":{"type":"string"},"payload":{}},"additionalProperties":false,"required":["payload","type"]},"type":{"type":"string","const":"Dispatch"}},"required":["action","type"]},"AddValidatorName<{params:{title:string;body:string;};}&{type:\"ShowError\";},\"ShowError\">":{"additionalProperties":false,"type":"object","properties":{"params":{"type":"object","properties":{"title":{"type":"string"},"body":{"type":"string"}},"additionalProperties":false,"required":["body","title"]},"type":{"type":"string","const":"ShowError"}},"required":["params","type"]},"AddValidatorName<{level:\"log\"|\"info\"|\"debug\"|\"warn\";args:any[];}&{type:\"FrontendConsole\";},\"FrontendConsole\">":{"additionalProperties":false,"type":"object","properties":{"level":{"enum":["debug","info","log","warn"],"type":"string"},"args":{"type":"array","items":{}},"type":{"type":"string","const":"FrontendConsole"}},"required":["args","level","type"]},"AddValidatorName<{title:string;}&{type:\"UpdateWidgetState\";},\"UpdateWidgetState\">":{"additionalProperties":false,"type":"object","properties":{"title":{"type":"string"},"type":{"type":"string","const":"UpdateWidgetState"}},"required":["title","type"]},"AddValidatorName<{window_ids:string[];}&{type:\"LockFrame\";},\"LockFrame\">":{"additionalProperties":false,"type":"object","properties":{"window_ids":{"type":"array","items":{"type":"string"}},"type":{"type":"string","const":"LockFrame"}},"required":["type","window_ids"]},"AddValidatorName<{window_ids:string[];}&{type:\"UnlockFrame\";},\"UnlockFrame\">":{"additionalProperties":false,"type":"object","properties":{"window_ids":{"type":"array","items":{"type":"string"}},"type":{"type":"string","const":"UnlockFrame"}},"required":["type","window_ids"]},"AddValidatorName<{queryId:string;baseRevision:number;}&{type:\"QueryState\";},\"QueryState\">":{"additionalProperties":false,"type":"object","properties":{"queryId":{"type":"string"},"baseRevision":{"type":"integer"},"type":{"type":"string","const":"QueryState"}},"required":["baseRevision","queryId","type"]},"AddValidatorName<{queryId:string;aspectRatio?:number|undefined;}&{type:\"QuerySnapshot\";},\"QuerySnapshot\">":{"additionalProperties":false,"type":"object","properties":{"queryId":{"type":"string"},"aspectRatio":{"type":"number"},"type":{"type":"string","const":"QuerySnapshot"}},"required":["queryId","type"]},"AddValidatorName<{ra:number;dec:number;fov?:number|undefined;duration:number;easingFunction?:\"linear\"|\"fastStart2\"|\"fastStart4\"|\"slowStart2\"|\"slowStart4\"|\"slowStartStop2\"|\"slowStartStop4\"|undefined;}&{type:\"JumpTo\";},\"JumpTo\">":{"additionalProperties":false,"type":"object","properties":{"ra":{"type":"number"},"dec":{"type":"number"},"fov":{"type":"number"},"duration":{"type":"number"},"easingFunction":{"enum":["fastStart2","fastStart4","linear","slowStart2","slowStart4","slowStartStop2","slowStartStop4"],"type":"string"},"type":{"type":"string","const":"JumpTo"}},"required":["dec","duration","ra","type"]}}};
...
var _errs2 = errors;
if(typeof data.title !== "string"){
validate15.errors = [{instancePath:instancePath+"/title",schemaPath:"#/properties/title/type",keyword:"type",params:{type: "string"},message:"must be string"}];
return false;
}
var valid0 = _errs2 === errors;
}
...
validate15.errors = [{instancePath:instancePath+"/type",schemaPath:"#/properties/type/const",keyword:"const",params:{allowedValue: "UpdateWidgetState"},message:"must be equal to constant"}];
return false;
}
var valid0 = _errs4 === errors;
}
...
export const LockFrame = validate16;
var schema17 = {"$id":"LockFrame","additionalProperties":false,"type":"object","properties":{"window_ids":{"type":"array","items":{"type":"string"}},"type":{"type":"string","const":"LockFrame"}},"required":["type","window_ids"],"definitions":{"AddValidatorName<{id:string;title?:string|undefined;initialState?:unknown;queryId:string;layout?:\"merge-bottom\"|\"merge-left\"|\"merge-right\"|\"merge-top\"|\"split-bottom\"|\"split-left\"|\"split-right\"|\"tab-after\"|\"tab-before\"|undefined;},\"Open\">":{"additionalProperties":false,"type":"object","properties":{"id":{"type":"string"},"title":{"type":"string"},"initialState":{},"queryId":{"type":"string"},"layout":{"enum":["merge-bottom","merge-left","merge-right","merge-top","split-bottom","split-left","split-right","tab-after","tab-before"],"type":"string"}},"required":["id","queryId"]},"AddValidatorName<{type:\"Close\";},\"Close\">":{"additionalProperties":false,"type":"object","properties":{"type":{"type":"string","const":"Close"}},"required":["type"]},"AddValidatorName<{action:{type:string;payload:any;};}&{type:\"Dispatch\";},\"Dispatch\">":{"additionalProperties":false,"type":"object","properties":{"action":{"type":"object","properties":{"type":{"type":"string"},"payload":{}},"additionalProperties":false,"required":["payload","type"]},"type":{"type":"string","const":"Dispatch"}},"required":["action","type"]},"AddValidatorName<{params:{title:string;body:string;};}&{type:\"ShowError\";},\"ShowError\">":{"additionalProperties":false,"type":"object","properties":{"params":{"type":"object","properties":{"title":{"type":"string"},"body":{"type":"string"}},"additionalProperties":false,"required":["body","title"]},"type":{"type":"string","const":"ShowError"}},"required":["params","type"]},"AddValidatorName<{level:\"log\"|\"info\"|\"debug\"|\"warn\";args:any[];}&{type:\"FrontendConsole\";},\"FrontendConsole\">":{"additionalProperties":false,"type":"object","properties":{"level":{"enum":["debug","info","log","warn"],"type":"string"},"args":{"type":"array","items":{}},"type":{"type":"string","const":"FrontendConsole"}},"required":["args","level","type"]},"AddValidatorName<{title:string;}&{type:\"UpdateWidgetState\";},\"UpdateWidgetState\">":{"additionalProperties":false,"type":"object","properties":{"title":{"type":"string"},"type":{"type":"string","const":"UpdateWidgetState"}},"required":["title","type"]},"AddValidatorName<{window_ids:string[];}&{type:\"LockFrame\";},\"LockFrame\">":{"additionalProperties":false,"type":"object","properties":{"window_ids":{"type":"array","items":{"type":"string"}},"type":{"type":"string","const":"LockFrame"}},"required":["type","window_ids"]},"AddValidatorName<{window_ids:string[];}&{type:\"UnlockFrame\";},\"UnlockFrame\">":{"additionalProperties":false,"type":"object","properties":{"window_ids":{"type":"array","items":{"type":"string"}},"type":{"type":"string","const":"UnlockFrame"}},"required":["type","window_ids"]},"AddValidatorName<{queryId:string;baseRevision:number;}&{type:\"QueryState\";},\"QueryState\">":{"additionalProperties":false,"type":"object","properties":{"queryId":{"type":"string"},"baseRevision":{"type":"integer"},"type":{"type":"string","const":"QueryState"}},"required":["baseRevision","queryId","type"]},"AddValidatorName<{queryId:string;aspectRatio?:number|undefined;}&{type:\"QuerySnapshot\";},\"QuerySnapshot\">":{"additionalProperties":false,"type":"object","properties":{"queryId":{"type":"string"},"aspectRatio":{"type":"number"},"type":{"type":"string","const":"QuerySnapshot"}},"required":["queryId","type"]},"AddValidatorName<{ra:number;dec:number;fov?:number|undefined;duration:number;easingFunction?:\"linear\"|\"fastStart2\"|\"fastStart4\"|\"slowStart2\"|\"slowStart4\"|\"slowStartStop2\"|\"slowStartStop4\"|undefined;}&{type:\"JumpTo\";},\"JumpTo\">":{"additionalProperties":false,"type":"object","properties":{"ra":{"type":"number"},"dec":{"type":"number"},"fov":{"type":"number"},"duration":{"type":"number"},"easingFunction":{"enum":["fastStart2","fastStart4","linear","slowStart2","slowStart4","slowStartStop2","slowStartStop4"],"type":"string"},"type":{"type":"string","const":"JumpTo"}},"required":["dec","duration","ra","type"]}}};
...
if("LockFrame" !== data2){
validate16.errors = [{instancePath:instancePath+"/type",schemaPath:"#/properties/type/const",keyword:"const",params:{allowedValue: "LockFrame"},message:"must be equal to constant"}];
return false;
}
var valid0 = _errs6 === errors;
}
...
export const UnlockFrame = validate17;
var schema18 = {"$id":"UnlockFrame","additionalProperties":false,"type":"object","properties":{"window_ids":{"type":"array","items":{"type":"string"}},"type":{"type":"string","const":"UnlockFrame"}},"required":["type","window_ids"],"definitions":{"AddValidatorName<{id:string;title?:string|undefined;initialState?:unknown;queryId:string;layout?:\"merge-bottom\"|\"merge-left\"|\"merge-right\"|\"merge-top\"|\"split-bottom\"|\"split-left\"|\"split-right\"|\"tab-after\"|\"tab-before\"|undefined;},\"Open\">":{"additionalProperties":false,"type":"object","properties":{"id":{"type":"string"},"title":{"type":"string"},"initialState":{},"queryId":{"type":"string"},"layout":{"enum":["merge-bottom","merge-left","merge-right","merge-top","split-bottom","split-left","split-right","tab-after","tab-before"],"type":"string"}},"required":["id","queryId"]},"AddValidatorName<{type:\"Close\";},\"Close\">":{"additionalProperties":false,"type":"object","properties":{"type":{"type":"string","const":"Close"}},"required":["type"]},"AddValidatorName<{action:{type:string;payload:any;};}&{type:\"Dispatch\";},\"Dispatch\">":{"additionalProperties":false,"type":"object","properties":{"action":{"type":"object","properties":{"type":{"type":"string"},"payload":{}},"additionalProperties":false,"required":["payload","type"]},"type":{"type":"string","const":"Dispatch"}},"required":["action","type"]},"AddValidatorName<{params:{title:string;body:string;};}&{type:\"ShowError\";},\"ShowError\">":{"additionalProperties":false,"type":"object","properties":{"params":{"type":"object","properties":{"title":{"type":"string"},"body":{"type":"string"}},"additionalProperties":false,"required":["body","title"]},"type":{"type":"string","const":"ShowError"}},"required":["params","type"]},"AddValidatorName<{level:\"log\"|\"info\"|\"debug\"|\"warn\";args:any[];}&{type:\"FrontendConsole\";},\"FrontendConsole\">":{"additionalProperties":false,"type":"object","properties":{"level":{"enum":["debug","info","log","warn"],"type":"string"},"args":{"type":"array","items":{}},"type":{"type":"string","const":"FrontendConsole"}},"required":["args","level","type"]},"AddValidatorName<{title:string;}&{type:\"UpdateWidgetState\";},\"UpdateWidgetState\">":{"additionalProperties":false,"type":"object","properties":{"title":{"type":"string"},"type":{"type":"string","const":"UpdateWidgetState"}},"required":["title","type"]},"AddValidatorName<{window_ids:string[];}&{type:\"LockFrame\";},\"LockFrame\">":{"additionalProperties":false,"type":"object","properties":{"window_ids":{"type":"array","items":{"type":"string"}},"type":{"type":"string","const":"LockFrame"}},"required":["type","window_ids"]},"AddValidatorName<{window_ids:string[];}&{type:\"UnlockFrame\";},\"UnlockFrame\">":{"additionalProperties":false,"type":"object","properties":{"window_ids":{"type":"array","items":{"type":"string"}},"type":{"type":"string","const":"UnlockFrame"}},"required":["type","window_ids"]},"AddValidatorName<{queryId:string;baseRevision:number;}&{type:\"QueryState\";},\"QueryState\">":{"additionalProperties":false,"type":"object","properties":{"queryId":{"type":"string"},"baseRevision":{"type":"integer"},"type":{"type":"string","const":"QueryState"}},"required":["baseRevision","queryId","type"]},"AddValidatorName<{queryId:string;aspectRatio?:number|undefined;}&{type:\"QuerySnapshot\";},\"QuerySnapshot\">":{"additionalProperties":false,"type":"object","properties":{"queryId":{"type":"string"},"aspectRatio":{"type":"number"},"type":{"type":"string","const":"QuerySnapshot"}},"required":["queryId","type"]},"AddValidatorName<{ra:number;dec:number;fov?:number|undefined;duration:number;easingFunction?:\"linear\"|\"fastStart2\"|\"fastStart4\"|\"slowStart2\"|\"slowStart4\"|\"slowStartStop2\"|\"slowStartStop4\"|undefined;}&{type:\"JumpTo\";},\"JumpTo\">":{"additionalProperties":false,"type":"object","properties":{"ra":{"type":"number"},"dec":{"type":"number"},"fov":{"type":"number"},"duration":{"type":"number"},"easingFunction":{"enum":["fastStart2","fastStart4","linear","slowStart2","slowStart4","slowStartStop2","slowStartStop4"],"type":"string"},"type":{"type":"string","const":"JumpTo"}},"required":["dec","duration","ra","type"]}}};
...
var _errs4 = errors;
if(typeof data0[i0] !== "string"){
validate17.errors = [{instancePath:instancePath+"/window_ids/" + i0,schemaPath:"#/properties/window_ids/items/type",keyword:"type",params:{type: "string"},message:"must be string"}];
return false;
}
var valid1 = _errs4 === errors;
if(!valid1){
...
validate17.errors = [{instancePath:instancePath+"/window_ids",schemaPath:"#/properties/window_ids/type",keyword:"type",params:{type: "array"},message:"must be array"}];
return false;
}
}
var valid0 = _errs2 === errors;
...
validate17.errors = [{instancePath:instancePath+"/type",schemaPath:"#/properties/type/const",keyword:"const",params:{allowedValue: "UnlockFrame"},message:"must be equal to constant"}];
return false;
}
var valid0 = _errs6 === errors;
}
...
export const QueryState = validate18;
var schema19 = {"$id":"QueryState","additionalProperties":false,"type":"object","properties":{"queryId":{"type":"string"},"baseRevision":{"type":"integer"},"type":{"type":"string","const":"QueryState"}},"required":["baseRevision","queryId","type"],"definitions":{"AddValidatorName<{id:string;title?:string|undefined;initialState?:unknown;queryId:string;layout?:\"merge-bottom\"|\"merge-left\"|\"merge-right\"|\"merge-top\"|\"split-bottom\"|\"split-left\"|\"split-right\"|\"tab-after\"|\"tab-before\"|undefined;},\"Open\">":{"additionalProperties":false,"type":"object","properties":{"id":{"type":"string"},"title":{"type":"string"},"initialState":{},"queryId":{"type":"string"},"layout":{"enum":["merge-bottom","merge-left","merge-right","merge-top","split-bottom","split-left","split-right","tab-after","tab-before"],"type":"string"}},"required":["id","queryId"]},"AddValidatorName<{type:\"Close\";},\"Close\">":{"additionalProperties":false,"type":"object","properties":{"type":{"type":"string","const":"Close"}},"required":["type"]},"AddValidatorName<{action:{type:string;payload:any;};}&{type:\"Dispatch\";},\"Dispatch\">":{"additionalProperties":false,"type":"object","properties":{"action":{"type":"object","properties":{"type":{"type":"string"},"payload":{}},"additionalProperties":false,"required":["payload","type"]},"type":{"type":"string","const":"Dispatch"}},"required":["action","type"]},"AddValidatorName<{params:{title:string;body:string;};}&{type:\"ShowError\";},\"ShowError\">":{"additionalProperties":false,"type":"object","properties":{"params":{"type":"object","properties":{"title":{"type":"string"},"body":{"type":"string"}},"additionalProperties":false,"required":["body","title"]},"type":{"type":"string","const":"ShowError"}},"required":["params","type"]},"AddValidatorName<{level:\"log\"|\"info\"|\"debug\"|\"warn\";args:any[];}&{type:\"FrontendConsole\";},\"FrontendConsole\">":{"additionalProperties":false,"type":"object","properties":{"level":{"enum":["debug","info","log","warn"],"type":"string"},"args":{"type":"array","items":{}},"type":{"type":"string","const":"FrontendConsole"}},"required":["args","level","type"]},"AddValidatorName<{title:string;}&{type:\"UpdateWidgetState\";},\"UpdateWidgetState\">":{"additionalProperties":false,"type":"object","properties":{"title":{"type":"string"},"type":{"type":"string","const":"UpdateWidgetState"}},"required":["title","type"]},"AddValidatorName<{window_ids:string[];}&{type:\"LockFrame\";},\"LockFrame\">":{"additionalProperties":false,"type":"object","properties":{"window_ids":{"type":"array","items":{"type":"string"}},"type":{"type":"string","const":"LockFrame"}},"required":["type","window_ids"]},"AddValidatorName<{window_ids:string[];}&{type:\"UnlockFrame\";},\"UnlockFrame\">":{"additionalProperties":false,"type":"object","properties":{"window_ids":{"type":"array","items":{"type":"string"}},"type":{"type":"string","const":"UnlockFrame"}},"required":["type","window_ids"]},"AddValidatorName<{queryId:string;baseRevision:number;}&{type:\"QueryState\";},\"QueryState\">":{"additionalProperties":false,"type":"object","properties":{"queryId":{"type":"string"},"baseRevision":{"type":"integer"},"type":{"type":"string","const":"QueryState"}},"required":["baseRevision","queryId","type"]},"AddValidatorName<{queryId:string;aspectRatio?:number|undefined;}&{type:\"QuerySnapshot\";},\"QuerySnapshot\">":{"additionalProperties":false,"type":"object","properties":{"queryId":{"type":"string"},"aspectRatio":{"type":"number"},"type":{"type":"string","const":"QuerySnapshot"}},"required":["queryId","type"]},"AddValidatorName<{ra:number;dec:number;fov?:number|undefined;duration:number;easingFunction?:\"linear\"|\"fastStart2\"|\"fastStart4\"|\"slowStart2\"|\"slowStart4\"|\"slowStartStop2\"|\"slowStartStop4\"|undefined;}&{type:\"JumpTo\";},\"JumpTo\">":{"additionalProperties":false,"type":"object","properties":{"ra":{"type":"number"},"dec":{"type":"number"},"fov":{"type":"number"},"duration":{"type":"number"},"easingFunction":{"enum":["fastStart2","fastStart4","linear","slowStart2","slowStart4","slowStartStop2","slowStartStop4"],"type":"string"},"type":{"type":"string","const":"JumpTo"}},"required":["dec","duration","ra","type"]}}};
...
if(data && typeof data == "object" && !Array.isArray(data)){
var missing0;
if((((data.baseRevision === undefined) && (missing0 = "baseRevision")) || ((data.queryId === undefined) && (missing0 = "queryId"))) || ((data.type === undefined) && (missing0 = "type"))){
...
var _errs1 = errors;
for(var key0 in data){
if(!(((key0 === "queryId") || (key0 === "baseRevision")) || (key0 === "type"))){
...
var data1 = data.baseRevision;
var _errs4 = errors;
if(!(((typeof data1 == "number") && (!(data1 % 1) && !isNaN(data1))) && (isFinite(data1)))){
validate18.errors = [{instancePath:instancePath+"/baseRevision",schemaPath:"#/properties/baseRevision/type",keyword:"type",params:{type: "integer"},message:"must be integer"}];
return false;
}
var valid0 = _errs4 === errors;
}
...
if("QueryState" !== data2){
validate18.errors = [{instancePath:instancePath+"/type",schemaPath:"#/properties/type/const",keyword:"const",params:{allowedValue: "QueryState"},message:"must be equal to constant"}];
return false;
}
var valid0 = _errs6 === errors;
}
...
export const QuerySnapshot = validate19;
var schema20 = {"$id":"QuerySnapshot","additionalProperties":false,"type":"object","properties":{"queryId":{"type":"string"},"aspectRatio":{"type":"number"},"type":{"type":"string","const":"QuerySnapshot"}},"required":["queryId","type"],"definitions":{"AddValidatorName<{id:string;title?:string|undefined;initialState?:unknown;queryId:string;layout?:\"merge-bottom\"|\"merge-left\"|\"merge-right\"|\"merge-top\"|\"split-bottom\"|\"split-left\"|\"split-right\"|\"tab-after\"|\"tab-before\"|undefined;},\"Open\">":{"additionalProperties":false,"type":"object","properties":{"id":{"type":"string"},"title":{"type":"string"},"initialState":{},"queryId":{"type":"string"},"layout":{"enum":["merge-bottom","merge-left","merge-right","merge-top","split-bottom","split-left","split-right","tab-after","tab-before"],"type":"string"}},"required":["id","queryId"]},"AddValidatorName<{type:\"Close\";},\"Close\">":{"additionalProperties":false,"type":"object","properties":{"type":{"type":"string","const":"Close"}},"required":["type"]},"AddValidatorName<{action:{type:string;payload:any;};}&{type:\"Dispatch\";},\"Dispatch\">":{"additionalProperties":false,"type":"object","properties":{"action":{"type":"object","properties":{"type":{"type":"string"},"payload":{}},"additionalProperties":false,"required":["payload","type"]},"type":{"type":"string","const":"Dispatch"}},"required":["action","type"]},"AddValidatorName<{params:{title:string;body:string;};}&{type:\"ShowError\";},\"ShowError\">":{"additionalProperties":false,"type":"object","properties":{"params":{"type":"object","properties":{"title":{"type":"string"},"body":{"type":"string"}},"additionalProperties":false,"required":["body","title"]},"type":{"type":"string","const":"ShowError"}},"required":["params","type"]},"AddValidatorName<{level:\"log\"|\"info\"|\"debug\"|\"warn\";args:any[];}&{type:\"FrontendConsole\";},\"FrontendConsole\">":{"additionalProperties":false,"type":"object","properties":{"level":{"enum":["debug","info","log","warn"],"type":"string"},"args":{"type":"array","items":{}},"type":{"type":"string","const":"FrontendConsole"}},"required":["args","level","type"]},"AddValidatorName<{title:string;}&{type:\"UpdateWidgetState\";},\"UpdateWidgetState\">":{"additionalProperties":false,"type":"object","properties":{"title":{"type":"string"},"type":{"type":"string","const":"UpdateWidgetState"}},"required":["title","type"]},"AddValidatorName<{window_ids:string[];}&{type:\"LockFrame\";},\"LockFrame\">":{"additionalProperties":false,"type":"object","properties":{"window_ids":{"type":"array","items":{"type":"string"}},"type":{"type":"string","const":"LockFrame"}},"required":["type","window_ids"]},"AddValidatorName<{window_ids:string[];}&{type:\"UnlockFrame\";},\"UnlockFrame\">":{"additionalProperties":false,"type":"object","properties":{"window_ids":{"type":"array","items":{"type":"string"}},"type":{"type":"string","const":"UnlockFrame"}},"required":["type","window_ids"]},"AddValidatorName<{queryId:string;baseRevision:number;}&{type:\"QueryState\";},\"QueryState\">":{"additionalProperties":false,"type":"object","properties":{"queryId":{"type":"string"},"baseRevision":{"type":"integer"},"type":{"type":"string","const":"QueryState"}},"required":["baseRevision","queryId","type"]},"AddValidatorName<{queryId:string;aspectRatio?:number|undefined;}&{type:\"QuerySnapshot\";},\"QuerySnapshot\">":{"additionalProperties":false,"type":"object","properties":{"queryId":{"type":"string"},"aspectRatio":{"type":"number"},"type":{"type":"string","const":"QuerySnapshot"}},"required":["queryId","type"]},"AddValidatorName<{ra:number;dec:number;fov?:number|undefined;duration:number;easingFunction?:\"linear\"|\"fastStart2\"|\"fastStart4\"|\"slowStart2\"|\"slowStart4\"|\"slowStartStop2\"|\"slowStartStop4\"|undefined;}&{type:\"JumpTo\";},\"JumpTo\">":{"additionalProperties":false,"type":"object","properties":{"ra":{"type":"number"},"dec":{"type":"number"},"fov":{"type":"number"},"duration":{"type":"number"},"easingFunction":{"enum":["fastStart2","fastStart4","linear","slowStart2","slowStart4","slowStartStop2","slowStartStop4"],"type":"string"},"type":{"type":"string","const":"JumpTo"}},"required":["dec","duration","ra","type"]}}};
...
var _errs2 = errors;
if(typeof data.queryId !== "string"){
validate19.errors = [{instancePath:instancePath+"/queryId",schemaPath:"#/properties/queryId/type",keyword:"type",params:{type: "string"},message:"must be string"}];
return false;
}
var valid0 = _errs2 === errors;
}
...
validate19.errors = [{instancePath:instancePath+"/aspectRatio",schemaPath:"#/properties/aspectRatio/type",keyword:"type",params:{type: "number"},message:"must be number"}];
return false;
}
var valid0 = _errs4 === errors;
}
...
validate19.errors = [{instancePath:instancePath+"/type",schemaPath:"#/properties/type/const",keyword:"const",params:{allowedValue: "QuerySnapshot"},message:"must be equal to constant"}];
return false;
}
var valid0 = _errs6 === errors;
}
...
validate20.errors = [{instancePath:instancePath+"/ra",schemaPath:"#/properties/ra/type",keyword:"type",params:{type: "number"},message:"must be number"}];
return false;
}
var valid0 = _errs2 === errors;
}
...
var _errs4 = errors;
if(!((typeof data1 == "number") && (isFinite(data1)))){
validate20.errors = [{instancePath:instancePath+"/dec",schemaPath:"#/properties/dec/type",keyword:"type",params:{type: "number"},message:"must be number"}];
return false;
}
var valid0 = _errs4 === errors;
}
...
validate20.errors = [{instancePath:instancePath+"/fov",schemaPath:"#/properties/fov/type",keyword:"type",params:{type: "number"},message:"must be number"}];
return false;
}
var valid0 = _errs6 === errors;
}
...
validate20.errors = [{instancePath:instancePath+"/duration",schemaPath:"#/properties/duration/type",keyword:"type",params:{type: "number"},message:"must be number"}];
return false;
}
var valid0 = _errs8 === errors;
}
...
validate20.errors = [{instancePath:instancePath+"/easingFunction",schemaPath:"#/properties/easingFunction/type",keyword:"type",params:{type: "string"},message:"must be string"}];
return false;
}
...
validate20.errors = [{instancePath:instancePath+"/easingFunction",schemaPath:"#/properties/easingFunction/enum",keyword:"enum",params:{allowedValues: schema21.properties.easingFunction.enum},message:"must be equal to one of the allowed values"}];
return false;
}
...
if("JumpTo" !== data5){
validate20.errors = [{instancePath:instancePath+"/type",schemaPath:"#/properties/type/const",keyword:"const",params:{allowedValue: "JumpTo"},message:"must be equal to constant"}];
return false;
}
