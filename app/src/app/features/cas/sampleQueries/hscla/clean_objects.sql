...
FROM
    hscla2020_wide.forced  AS f1
  LEFT JOIN
    hscla2020_wide.forced2 AS f2 USING (object_id)
  LEFT JOIN
    hscla2020_wide.meas   AS m1 USING (object_id)
  LEFT JOIN
    hscla2020_wide.meas2  AS m2 USING (object_id)
WHERE
