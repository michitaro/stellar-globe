...
FROM builder as typescript-typevalidator
COPY ./typescript-typevalidator /src/typescript-typevalidator
RUN make -C /src/typescript-typevalidator
...
# app
FROM builder as app
COPY --from=typescript-typevalidator /src/typescript-typevalidator /src/typescript-typevalidator
COPY --from=stellar-globe /src/stellar-globe /src/stellar-globe
